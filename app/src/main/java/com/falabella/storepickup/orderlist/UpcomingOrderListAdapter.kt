...
class UpcomingOrderListAdapter(
...
) : RecyclerView.Adapter<UpcomingOrderListAdapter.ViewHolder>() {
    ...
    interface ItemClickListener {
        fun onOrderClicked(orderId: String, storeAppointmentModel: StoreAppointmentModel)
    }
}
