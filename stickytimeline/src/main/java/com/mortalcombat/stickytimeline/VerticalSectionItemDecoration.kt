...
import com.mortalcombat.stickytimeline.Utils.dpToValue
...
class VerticalSectionItemDecoration(
    ...
    private var defaultOffset = 8.dpToValue(context).toInt()
    private var headerOffset = defaultOffset * 4
        ...
        childInContact?.let {
            ...
            if (getIsSection(contractPosition) && recyclerViewAttr.isSticky) {
                ...
                headerView?.let {
                    ...
                    setMargins(it, it.marginTop, it.marginLeft, it.marginRight, headerOffset)
                }
            }
        }
